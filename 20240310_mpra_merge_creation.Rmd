...
nrow(emvars_in_dhs)
# Primary T cell emVars: 
# Primary T cell emVars in DHS: 
```
...
# rs5855282 / 3:189662658:GT:G has been eliminated because it was not in the sequencing library. This is done in /nfs/jray/screens/ALL_MPRAs/Ho_et_al_analysis/Downstream_Analysis/20240310_mpra_analysis/20240310_eliminate_SNP.Rmd 
...
for(i in 1:nrow(mpra.pics)){
  ...
  # if(mpra.pics[i,]$win_pics=="MS_pics" & mpra.pics[i,]$MS_pval<=8){
  #  mpra.pics[i,]$win_pics<-NA
  #} # if win_pics says MS_pics and MS_pval<=8 then the win_pics is back to NA
  # if(mpra.pics[i,]$win_pics=="RA_pics" & mpra.pics[i,]$RA_pval<=8){
  #  mpra.pics[i,]$win_pics<-NA
  #} # if win_pics says RA_pics and RA_pval<=8 then the win_pics is back to NA
