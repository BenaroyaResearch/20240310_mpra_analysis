...
# How many active elements are there with out the FC filter?
# Create absolute value columns 
mpra_merge$abs.A.log2FC <- abs(mpra_merge$A.log2FC)
mpra_merge$abs.B.log2FC <- abs(mpra_merge$B.log2FC)
nrow(subset(mpra_merge, (abs.A.log2FC>1 & A.logPadj_BF>2) | (abs.B.log2FC>1 & B.logPadj_BF>2)))
```
...
write.table(dat.enrichment, paste0(data.dir,"/",plots_id,"_mpra_pics_enrichment_plot_all_loci_table"), row.names = F, col.names = T, sep="\t", quote=F)  
...
write.table(dat.enrichment, paste0(data.dir,"/",plots_id,"_mpra_pics_enrichment_plot_dhs_loci_only_table"), row.names = F, col.names = T, sep="\t", quote=F)
